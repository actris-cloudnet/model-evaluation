...
def test_relative_error():
    from model_evaluation.statistics.statistical_methods import relative_error
...
def test_relative_error_mask():
    ...
    model = ma.array([[1, 2, 2, 3],
                      [2, 1, 10, 1]])
    model.mask = np.array([[0, 0, 0, 1],
                           [0, 1, 0, 1]])
    observation = ma.array([[1, 2, 5, 4],
                            [4, 6, 8, 1]])
...
def test_absolute_error():
    from model_evaluation.statistics.statistical_methods import absolute_error
    model = ma.array([[0.1, 0.2, 0.2, 0.3],
                      [0.2, 0.4, 1.0, 0.0]])
...
def test_histogram():
    from model_evaluation.statistics.statistical_methods import histogram
    model = ma.array([[1, 2, 2, 3],
                      [2, 4, 10, 1]])
    observation = ma.array([[3, 2, 1, 4],
                            [4, 6, 8, 4]])
...
def test_vertical_profile():
    from model_evaluation.statistics.statistical_methods import vertical_profile
    model = ma.array([[0, 2, 2, 3],
                      [2, 4, 10, 1],
                      [4, 6, 6, 8]])
